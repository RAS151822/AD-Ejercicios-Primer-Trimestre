...
public class Marca implements Serializable{
    ...
    public Marca(String NombreMarca, int AñoCreacion, boolean Pelicula) {
    ...
    public Marca(int Id_Villano, String NombreMarca, int AñoCreacion, boolean Pelicula, String NombreVillano) {
