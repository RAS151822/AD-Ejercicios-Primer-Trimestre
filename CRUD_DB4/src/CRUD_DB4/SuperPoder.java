 ...
 * @author RASPUTIN
 */
public class SuperPoder implements Serializable{
    ...
    public SuperPoder(String NombrePoder, int Daño, int Potencia) {
    ...
    public SuperPoder(int id_SuperHeroe, String NombrePoder, int Daño, int Potencia, String NombreSuperHeroe) {
