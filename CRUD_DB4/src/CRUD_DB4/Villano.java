...
public class Villano implements Serializable{
    ...
    public Villano(String NombreVillano, String Habilidad, boolean mascara) {
    ...
    public Villano(int Id_SuperHeroe, String NombreVillano, String Habilidad, boolean mascara, char genero, String NombreSuperHeroe) {
